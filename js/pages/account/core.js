...
export class UIManager {
  constructor() {
    ...
    this.userRole = 'traveler'; // Default role
  }
...
export class AccountManager {
    ...
    try {
      ...
      if (savedUserData) {
        ...
        const mergedUser = {
          ...
          role: authRole || this.userData.userData.role || 'traveler' // Ensure role is set
        };
  ...
  initializeUI() {
    ...
    let initialSection = 'profile'; // Default to profile
  ...
  showSection(sectionId) {
    ...
    if ((isGuideSection && this.user.role !== 'guide') ||
      ...
      if (this.user.role === 'guide') {
        sectionId = 'guide'; // Guide dashboard
      } else {
        sectionId = 'profile'; // Default to profile for travelers
      }
