...
import { loadPartial } from '/tsafira-travel-planner/core/loader.js';
...
document.addEventListener('DOMContentLoaded', async function() {
  try {
    ...
    await loadPartial('/tsafira-travel-planner/partials/header.html', 'header-placeholder');
    await loadPartial('/tsafira-travel-planner/partials/footer.html', 'footer-placeholder');
    ...
    const allCities = await apiGet('/tsafira-travel-planner/assets/data/cities.json');
